...
input::-webkit-inner-spin-button {
   ...
   #preview { padding:40px; border:1px solid; background:#3d3d3d;     color: white; }
 </style>
...
<div class="col-sm-6"> <form method="POST" action="saveUploadImg.php">
        <div class="row ">
            <div class="col-md-6 ">
                <div id="live_camera"></div>
                <hr/>
				<div class="text-white" id="preview">Your captured image will appear here...</div>
				<br>
                <input type="button" class=" btn btn-info" value="Take Snapshot" onClick="capture_web_snapshot()">
