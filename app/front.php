...
<html>
   ...
   <body>
      ...
      <div class="col-sm-3" style="padding-left:50px;height:100%;">
         <div>
            <h3>Check Out Visitor(Manual)</h3>
         </div>
         <div style="padding-top:20px;display:block;">
            <form method= "POST" action = "">
               ...
               <?php {?>
               <input id="x" name ="logout" value = "Checkout" class="btn btn-danger" type ="submit" onclick='return confirm("Are you sure you want to Checkout?")'>
               <?php }?>
               <?php
            ...
            <br>
            <div class="form-group">
               <label class="control-label" id ="t" for="recept_id"> QR Code Scan : </label>
               <br>
               <input id="qrcodescan" name ="logout" class="btn btn-info" value = "Scan QR Code" type="submit" onclick='return confirm("Are you sure you want to Checkout?")'>
            </div>
      ...
      <div class="col-sm-5" style="padding-left: 50px;">
         ...
         <?php 
            ...
            $query = "SELECT * FROM info_visitor WHERE ReceiptID = '$showResultFor' AND Status = 'ONLINE' ";
                     ...
                     $qrcodepath = 'QRCodes/'.$showResultFor.".png";
					 $campath = 'upload/'.$showResultFor.".jpg";
         ...
         <div  class="row" >
            <div class="col-sm-8" style = "padding-left:25px;padding-top:15px; font-size:16px;">
               <p style="width: 678px;" id="col-1">Date :<?php echo $resultDetails['Date'];?>&nbsp;&nbsp;
                  Time in :&nbsp;<?php echo $resultDetails['TimeIN'];?>
               </p>
               ...
               <span id="col-1"><b>QRCode :</b><br> 
               <?php echo "<span><img src='".$qrcodepath."'></span>";?></span>  
               <?php echo "<span><img alt ='Image not availble'src='".$campath."'></span>";?></span> 
